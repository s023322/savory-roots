...
<div class="z-0 font-lato">
    <div class="mt-24 px-8 w-full max-w-7xl mx-auto">
        ...
        <Elements
            ...
            variables={{fontFamily: "Playfair Display, sans-serif, system-ui", colorDanger:"#ff0000", fontSizeBase:"16px", colorPrimaryText:"#faf5e9", colorText:"#451b00", colorPrimary:"#66754f", colorBackground:"#faf5e9", borderRadius:"8px"}}
            rules={{".Input":{fontFamily:"Spline Sans", padding:"8px"}}}
            >
