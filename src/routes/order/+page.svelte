...
<div class="font-lato">
    <div class="z-0 flex flex-col md:flex-row justify-center space-x-8">
        ...
        <div class="block max-md:mx-auto md:inline relative mt-8 md:mt-24 w-fit h-fit">
            <Toggle font="icons" pad="2" space="4" titles="{["Appetizers", "Dumplings", "Noodles", "Vegetables", "Soups", "Rices"]}" bind:tstate text="{["rice_bowl", "dinner_dining", "ramen_dining", "psychiatry", "soup_kitchen", "rice_bowl"]}"></Toggle>
        </div>
    </div>
