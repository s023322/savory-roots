...
<div class="z-0 font-lato text-black dark:text-white">
    ...
    <div class="relative top-0 w-full h-screen flex   justify-center items-center flex-col">
        ...
        <div class="absolute bottom-8 flex w-full h-min justify-center space-x-4">
                    <a href="/instagram.pdf" aria-label="Instagram" class="size-8 p-2 flex justify-center align-items transition duration-200 from-black to-black bg-linear-to-tl rounded-full fill-white    hover:from-light hover:to-dark active:from-white active:to-black active:animate-button">
                    ...
                    <a href="/X.png" aria-label="X" class="size-8 p-2 flex justify-center align-items transition duration-200 from-black to-black bg-linear-to-tl rounded-full fill-white    hover:from-light hover:to-dark active:from-white active:to-black active:animate-button">
